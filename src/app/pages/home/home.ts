...
export class HomeComponent implements AfterViewInit, OnInit {
  ...
  resumenHero: string = `
    ...
    cultural y comercial: el nuevo Mercado Don Francisco. Un proyecto apoyado por la IDCL que 
  ...
  infoGeneral = [
    ...
    `Inversión total estimada: 43 millones de pesos.`,
...
Con una inversión estimada en 43 millones de pesos y un aporte clave de la Intendencia en obra
